        ...
        return (
            <div style={{width:"212px", height:"112px"}}>
                <Slider {...settings}>
                    ...
                    <img className="slide__game_type" src={type8} alt="img"/>
                    <img className="slide__game_type" src={type9} alt="img"/>
                    <img className="slide__game_type" src={type10} alt="img"/>
                    <img className="slide__game_type" src={type1} alt="img"/>
                    <img className="slide__game_type" src={type2} alt="img"/>
                    <img className="slide__game_type" src={type3} alt="img"/>
                    <img className="slide__game_type" src={type4} alt="img"/>
                    <img className="slide__game_type" src={type5} alt="img"/>
                </Slider>
            </div>
        );
    }
