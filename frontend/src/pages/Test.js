...
const Test = (props) => {
    ...
    const question =
        [
            ...
            "선택에 따라 세계의 운명이... 어쩌구 하던.",
            "나는 그냥 잠만 잤다고! 왕국의 인간들은 탐욕에 눈이 멀어 내 핑계를 대면서 \n" +
            "자신들의 배를 불리고 있지!  "
        ]
    const answerYes = [
    ...
    const answerNo = [
        ...
        "판매한다면 좋은 값을 받을 것이다. ",
        "골렘을 파괴하고 아이템을 얻는다. ",
        "골렘의 이상한 소리는 무시하고 그냥 지나간다.",
        "원거리 마법으로 이곳저곳 찔러보며 약점을 찾는다. ",
        "보물상자에서 얻은 마법 스크롤로\n" +
        "<메테어>를 사용한다."
        , null,
        "잘 모르겠다",
